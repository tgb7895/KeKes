...
public class MenuFragment extends BaseFragment{
    ...
    protected View initView() {
        View view=View.inflate(mContext, R.layout.fragment_connection_menu,null);
        ...
        allUserCollectionAdapter = new AllUserCollectionAdapter(collections,1);
        getNetworkData();
    ...
    public void initViews(View v){
        recyclerView=v.findViewById(R.id.fragment_connection_menu_recycler_view);
            ...
            public void run() {
                try {
                    ...
                    Request request=new Request.Builder()
                            .url("http://"+ HttpUtil.SERVER+"/getAllUserCollection.do?user_id="+getUserId()+"&flag=1")
                            .build();
